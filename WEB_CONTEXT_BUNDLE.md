...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-955-erd-s-problem-955-9caf033e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-955"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-955-erd-s-problem-955-9caf033e-v1",
      "problem_contract_sha256": "ec86010633c9a45c05d017f8810261eba1d3e12b5be14219c2eb8a1a5e55eac3",
      "problem_id": "problem:um-ep-955-erd-s-problem-955-9caf033e",
      "route_id": "route:um-ep-955-erd-s-problem-955-9caf033e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-955-erd-s-problem-955-9caf033e-source-fidelity-01",
      "graph_id": "graph:um-ep-955-erd-s-problem-955-9caf033e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-955-erd-s-problem-955-9caf033e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-955-erd-s-problem-955-9caf033e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $ s(n)=\\sigma(n)-n=\\sum_{\\substack{d\\mid n\\\\ d<n}}d $ be the sum of proper divisors function. If $A\\subset \\mathbb{N}$ has density $0$ then $s^{-1}(A)$ must also have density $0$."
          },
          "statement_sha256": "7dc78437e5bf4a1df2e2280e1a23375e5be9f5bc18aea52235ad204f2894001b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-955-erd-s-problem-955-9caf033e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-955-erd-s-problem-955-9caf033e-root",
      "route_id": "route:um-ep-955-erd-s-problem-955-9caf033e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-955-cd5b7376bee0",
        "url": "https://www.unsolvedmath.com/problems/EP-955"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
